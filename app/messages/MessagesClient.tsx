...
export default function MessagesClient({
  ...
  conversations: Convo[];
  currentUser: { id: number; username: string; first_name: string; profile_picture?: string | null; family?: number };
  lunaName?: string;
}) {
      ...
      <div className={`${activeConvo ? 'hidden md:flex' : 'flex'} w-full md:w-72 border-r border-gray-100 flex-col flex-shrink-0`}>
        ...
        <div className="overflow-y-auto flex-1">
          {/* Family Chat entry — separate page, not an in-place conversation
              ...
              model: one shared room instead of a 1:1 conversation. Only
              shown to accounts flagged family. */}
          {currentUser.family !== 0 ? (
            <a href="/family-chat"
