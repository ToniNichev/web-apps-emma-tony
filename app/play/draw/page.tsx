...
import DrawGuessLobbyClient from './DrawGuessLobbyClient';

export const dynamic = 'force-dynamic';

export default async function DrawGuessLobbyPage() {
  ...
  return (
    <main className="max-w-2xl mx-auto px-4 pt-4 pb-8">
      <div className="mb-5">
        <h1 className="text-2xl font-bold brand-text">Draw &amp; Guess 🎨</h1>
        <p className="text-sm text-gray-400 mt-1">Invite friends, take turns drawing, guess the word!</p>
      </div>
      <DrawGuessLobbyClient initialRooms={rooms} friends={friends} />
    </main>
  );
}
